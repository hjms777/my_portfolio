    ...
    <main className="p-4 sm:p-8">
        ...
        <div className="flex flex-col justify-center items-center h-full">
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="text-center md:text-left">
              <p className="text-lg">
                안녕하세요! N년차 웹 개발자 OOO입니다. <br />
                사용자에게 더 나은 경험을 제공하는 것에 보람을 느끼며, <br />
                새로운 기술을 배우고 적용하는 것을 즐깁니다. <br />
                견고하고 확장 가능한 웹 애플리케이션을 만드는 데 관심이
                많습니다.
              </p>
            </div>
          </div>
      ...
      <Section id="experience">
        <div className="flex flex-col justify-center h-full px-32">
          ...
          <div className="relative border-l-2 border-teal-500 pl-16">
            {/*pl로 내용수정*/}
